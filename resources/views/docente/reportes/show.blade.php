        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-3">
                            <div class="info-box bg-gradient-danger">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number" style="font-size: 1.5rem;">
                                        @if($reporte->tienePdf())
                                            <a href="{{ route('docente.reportes.descargar-pdf', $reporte->id) }}" class="text-white">
                    ...
                    <!-- Botones de Acción - VERSIÓN DOCENTE (SIN PERFILES) -->
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="{{ route('docente.reportes.index') }}" class="btn btn-secondary">
                                    <i class="fas fa-arrow-left"></i> Volver al Listado
                                </a>
                                @if($reporte->tienePdf())
                                <a href="{{ route('docente.reportes.descargar-pdf', $reporte->id) }}" class="btn btn-danger">
                                    <i class="fas fa-file-pdf"></i> Descargar PDF
                                </a>
                                @endif
                                @if(!$reporte->visible_tutor)
                                <form action="{{ route('docente.reportes.publicar', $reporte->id) }}" method="POST" style="display: inline-block;">
                                    @csrf
                                ...
                                @else
                                <form action="{{ route('docente.reportes.despublicar', $reporte->id) }}" method="POST" style="display: inline-block;">
                                    @csrf
                                ...
                                @endif
                                <form action="{{ route('docente.reportes.calcular-datos', $reporte->id) }}" method="POST" style="display: inline-block;">
                                    @csrf
