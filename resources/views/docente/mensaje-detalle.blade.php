            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('docente.mensajeria') }}" class="btn btn-tool">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <strong><i class="fas fa-user"></i> De (Tutor):</strong>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            @endif
                            @if($mensaje->estudiante)
                                <a href="{{ route('docente.alumno.ficha', $mensaje->estudiante->id) }}" 
                                   class="btn btn-info">
                                    <i class="fas fa-id-card"></i> Ver Ficha del Estudiante
                                </a>
                            @endif
                            <a href="{{ route('docente.mensajeria') }}" class="btn btn-secondary">
                ...
                <form action="{{ route('docente.mensajeria.responder', $mensaje->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info">
                            <strong>Respondiendo a:</strong> {{ $mensaje->asunto }}<br>
