            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                <a href="{{ route('docente.comportamientos.index') }}" class="btn btn-secondary">
                                    <i class="fas fa-arrow-left"></i> Volver al Listado
                                </a>
                                @if(!$comportamiento->notificado_tutor)
                                <form action="{{ route('docente.comportamientos.notificar', $comportamiento->id) }}" method="POST" style="display: inline-block;">
                                    @csrf
                                ...
                                @else
                                <form action="{{ route('docente.comportamientos.cancelar-notificacion', $comportamiento->id) }}" method="POST" style="display: inline-block;">
                                    @csrf
